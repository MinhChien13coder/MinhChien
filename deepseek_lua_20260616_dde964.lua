...
-- [[ LOGIC TÌM VÀ LẤY NHIỆM VỤ (CheckQuest) ]]
function CheckQuest() 
    pcall(function()
        local MyLevel = LocalPlayer.Data.Level.Value
        -- (Giữ nguyên code CheckQuest cũ của bạn ở đây, mình đã chèn block dưới cho gọn)
        if World1 then
            ...
            elseif (MyLevel >= 210 and MyLevel <= 249) or SelectMonster == "Dangerous Prisone" then
                ...
                CFrameQuest = CFrame.new(5308.93115, 1.65517521, 475.120514, -0.0894274712, -5.00292918e-09, -0.995993316, 1.60817859e-09, 1, -5.16744869e-09, 0.995993316, -2.06384709e-09, -0.0894274712)
                CFrameMon = CFrame.new(5654.5634765625, 15.633401870539727, 866.2991943359375)
        ...
        if Config.AutoFarm and Config.BringMob then
            pcall(function()
                ...
                if character and character:FindFirstChild("HumanoidRootPart") then
                    ...
                    for _, mob in pairs(workspace:GetChildren()) do
                        if mob.Name == NameMon and mob:FindFirstChild("Humanoid") and mob.Humanoid.Health > 0 and mob:FindFirstChild("HumanoidRootPart") then
                            if (mob.HumanoidRootPart.Position - playerPos).Magnitude <= 300 then
