...
-- [[ Biến bổ sung cho auto farm nâng cao ]]
StartBring = false
BypassTP = true
MonFarm = ""
...
local function AutoHaki() end -- stub
            ...
            pcall(function()
                ...
                if character and character:FindFirstChild("HumanoidRootPart") then
                    ...
                    for _, mob in pairs(workspace:GetChildren()) do
                        if mob.Name == NameMon and mob:FindFirstChild("Humanoid") and mob.Humanoid.Health > 0 and mob:FindFirstChild("HumanoidRootPart") then
                            if (mob.HumanoidRootPart.Position - playerPos).Magnitude <= 30 then
...
-- [[ KILL AURA NÂNG CAO (sử dụng workspace.Enemies) ]]
task.spawn(function()
...
local Main = Instance.new("Frame", ScreenGui); Main.Size = UDim2.new(0, 240, 0, 530); Main.Position = UDim2.new(0.5, -120, 0.15, 0); Main.BackgroundColor3 = Color3.fromRGB(5, 5, 10); Main.Visible = false; Main.Active = true; Drag(Main)
...
local Holder = Instance.new("ScrollingFrame", Main); Holder.Size = UDim2.new(0.9, 0, 0.85, 0); Holder.Position = UDim2.new(0.05, 0, 0.1, 0); Holder.BackgroundTransparency = 1; Holder.CanvasSize = UDim2.new(0, 0, 2.0, 0); Holder.ScrollBarThickness = 0
